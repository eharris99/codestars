...
//    [self.collectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
    ...
    albumImages=@[@"beethoven piano sonatas", @"bob dylan boot", @"brahms requiem",@"dilla donuts", @"judy garland", @"moran artist in residence",@"moran same mother", @"nuyorican soul", @"pet sounds", @"petestrumentals"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.albumImage.image = [UIImage imageNamed:[albumImages objectAtIndex:indexPath.row]];
